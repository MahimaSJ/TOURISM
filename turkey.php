...
<html>
    ...
    <body>
        <h1>TURKEY</h1>
        <img src="./images/turkey.png" alt="" id="img">
        <p>Turkey is a stunning location that spans both Asia and Europe. It is stuffed to the gills with historic structures left over by a succession of civilisations, and it is also bestowed with a breathtaking landscape that never ceases to astound. Its gorgeous vistas, from the sun-drenched Mediterranean to the enormous mountain ranges and barren plains, are main attractions in and of themselves, as are its thriving cultures, famed cuisines, and extensive heritage.</p>
